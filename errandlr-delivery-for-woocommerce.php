...
define('WC_ERRAN_DL_MAIN_FILE', __FILE__);

/**
 * WooCommerce Errandlr Delivery Loader.
 *
 */
class WC_Errandlr_Delivery_Loader
{
    ...
    const PLUGIN_NAME = 'Errandlr Delivery for WooCommerce';

    /** the plugin slug, for action links */
    const PLUGIN_SLUG = 'errandlr';

    /** @var array the admin notices to add */
    private $notices = array();

    /** @var \WC_ErrandlrDelivery_Loader single instance of this class */
    ...
    public function init_plugin()
    {
        ...
        require_once(plugin_dir_path(__FILE__) . 'inc' . DIRECTORY_SEPARATOR . 'class-wc-Errandlr-delivery.php');

        wc_Errandlr_delivery();
    }

    public function plugin_action_links($links)
    {
        $links[] = '<a href="' . admin_url('admin.php?page=wc-settings&tab=shipping&section=Errandlr_delivery') . '">' . __('Settings') . '</a>';
        return $links;
    }
     ...
     *
     * @see \WC_ErrandlrDelivery_Loader_Loader::add_admin_notice()
     *
     */
